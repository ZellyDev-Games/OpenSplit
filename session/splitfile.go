...
//			Formatted: timer.FormatTimeToString(s.sob),
//		},
...
func (s *SplitFile) Save(persister Persister, windowParams WindowParams) error {
	...
	//if err != nil {
	//	var cancelled = &persistence.UserCancelledSave{}
...
//				}
//				if res != "yes" {
//					return nil, persistence.UserCancelledSave{Err: err}
//				}
//			}
...
func LoadSplitFile(persister Persister) (*SplitFile, error) {
	...
	//if err != nil {
	//	var userCancelled = &persistence.UserCancelledSave{}
...
func (s *SplitFile) getDefaultFileName() string {
	return fmt.Sprintf("%s-%s.osf", s.gameName, s.gameCategory)
}
