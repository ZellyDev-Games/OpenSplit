...
//
//	sf.BuildStats()
//	want := (sf.runs[0].splits[0].currentCumulative +
//		sf.runs[1].splits[0].currentCumulative +
//		sf.runs[2].splits[0].currentCumulative) / 3
//	if sf.segments[0].average != want {
//		t.Errorf("segment 1 average time: want %s got %s", want, sf.segments[0].average)
//	}
//
//	want = (sf.runs[0].splits[1].currentCumulative +
//		sf.runs[1].splits[1].currentCumulative +
//		sf.runs[2].splits[1].currentCumulative) / 3
